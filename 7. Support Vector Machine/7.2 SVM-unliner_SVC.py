...
def test_SVC_poly(*data):
    '''
    test SVC with poly kernel and different degree, gamma, coef0
    :param data:  train_data,test_data, train_target, test_target
    :return: None
    '''
    X_train,X_test,y_train,y_test=data
    ...
    ax.set_ylim(0,1.05)
    ax.legend(loc="best",framealpha=0.5)
    ### test r ，fix gamma with 10 ， degree fixed with 3######
    rs=range(0,20)
    train_scores=[]
    test_scores=[]
    for r in rs:
...
def test_SVC_rbf(*data):
    '''
    test SVC with gaussian kernel(rbf) and different gamma
    :param data:  train_data,test_data, train_target, test_target
    :return: None
    '''
    X_train,X_test,y_train,y_test=data
...
def test_SVC_sigmoid(*data):
    '''
    test SVC with sigmoid kernel and different gamma and coef0
    :param data:  train_data,test_data, train_target, test_target
    :return: None
    '''
    X_train,X_test,y_train,y_test=data
